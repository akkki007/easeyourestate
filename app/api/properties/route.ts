...
export async function GET(req: NextRequest) {
    ...
    const [properties, total] = await Promise.all([
        Property.find(filter)
            ...
            .skip(skip)
            .limit(limit)
            .select("slug title price rental_details pg_details specs location media purpose category propertyType amenities listingType featured publishedAt")
            .lean(),
...
export async function POST(req: NextRequest) {
    ...
    const property = await Property.create({
        ...
        price: data.purpose === "sell" && data.price ? {
        ...
        rental_details: (data.purpose === "rent" || data.purpose === "lease") ? data.rental_details : undefined,
        pg_details: data.purpose === "pg" ? data.pg_details : undefined,
        specs: data.specs,
