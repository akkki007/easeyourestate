...
export default function PropertyDetailPage() {
 ...
 >
 <div className="p-2 rounded-full group-hover:bg-primary transition-colors">
 ...
 ?"bg-primary border-primary text-primary shadow-sm"
 :"bg-card border-border text-muted-foreground hover:text-primary hover:border-primary hover:bg-primary"
 }`}
 >
 <Heart className={`w-5 h-5 ${isLiked ?"fill-current":""}`} />
 </button>
 <button className="p-2.5 rounded-full bg-card border border-border text-muted-foreground hover:text-primary hover:border-primary hover:bg-primary transition-all">
 ...
 <div className="flex items-center gap-2">
 <span className="px-3 py-1 bg-primary text-primary text-[11px] font-bold rounded-full uppercase tracking-widest border border-primary">
 ...
 <div className="flex items-center gap-1.5 text-primary bg-primary w-fit px-3 py-1 rounded-full text-[10px] font-bold border border-primary uppercase tracking-wider">
 ...
 <div className="w-14 h-14 rounded-2xl bg-primary flex items-center justify-center text-primary font-black text-xl overflow-hidden border border-primary">
