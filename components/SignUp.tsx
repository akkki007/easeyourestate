        ...
        <div className="flex-1 flex flex-col justify-between p-10 bg-white">
          ...
          <div className="flex-1">
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link href="/login" className="text-gray-900 font-semibold underline underline-offset-2 hover:text-purple-600 transition-colors">
                Login
              </Link>
            </p>
          </div>
          ...
          <div className="hidden md:flex w-[45%] relative overflow-hidden rounded-r-2xl">
            ...
            <div className="relative z-10 flex flex-col justify-end p-10 h-full">
              ...
              <p className="text-white/70 text-sm leading-relaxed mb-6">
                Join thousands of happy homeowners and renters who found their perfect space with Estatery.
              </p>
