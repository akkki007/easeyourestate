                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {purposeOptions.map((purpose) => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all border ${selectedPurpose === purpose.toLowerCase()
                                                            ? "bg-accent text-white border-accent"
                                                            : "bg-hover text-muted-foreground border-border hover:border-accent/50 hover:text-primary"
                                                        }`}
                                                >
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {bhkOptions.map((bhk) => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all border ${selectedBhk === bhk
                                                            ? "bg-accent text-white border-accent"
                                                            : "bg-hover text-muted-foreground border-border hover:border-accent/50 hover:text-primary"
                                                        }`}
                                                >
...
function SavedPropertyCard({ property }: { property: any }) {
    ...
    return (
        <div className="bg-card border border-border rounded-xl overflow-hidden hover:border-border transition-colors group relative">
            ...
            <SavedPropertyButton propertyId={property._id} className="top-2 right-2 p-1.5" iconClassName="w-4 h-4" />
        </div>
    );
}
