      ...
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-24 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="z-10">
          ...
          <div className="flex flex-wrap gap-4 mb-12">
            ...
            <button className="px-8 py-4 border border-gray-200 dark:border-border-dark bg-white dark:bg-card-dark font-medium rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
              Learn More
            </button>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-gray-50 dark:bg-card-dark border border-gray-200 dark:border-border-dark p-6 rounded-2xl">
              <div className="text-3xl font-bold mb-1">200+</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">Happy Customers</div>
            </div>
            <div className="bg-gray-50 dark:bg-card-dark border border-gray-200 dark:border-border-dark p-6 rounded-2xl">
              <div className="text-3xl font-bold mb-1">10k+</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">Properties For Clients</div>
            </div>
            <div className="bg-gray-50 dark:bg-card-dark border border-gray-200 dark:border-border-dark p-6 rounded-2xl">
