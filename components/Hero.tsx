        ...
        <div className="w-full max-w-3xl bg-card rounded-2xl shadow-2xl shadow-black/30 overflow-visible">
          ...
          <div className="flex items-center gap-0 p-4 pb-0">
                ...
                <div className="absolute top-full left-0 right-0 mt-1 bg-card rounded-xl shadow-xl border border-gray-100 py-1 z-50 max-h-96 overflow-y-auto">
                  {suggestions.map((s) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-3 hover:bg-purple-50 transition-colors flex items-start justify-between group border-b border-gray-50 last:border-0"
                    >
                      <div className="flex items-start gap-3">
                        <div className="mt-1 w-8 h-8 rounded-lg bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-purple-100 group-hover:text-purple-600 transition-colors">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 m-1 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold rounded-xl transition-colors shadow-sm shadow-purple-200"
            >
