              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    disabled={saving}
                    className="px-6 py-2.5 rounded-xl bg-accent text-white text-sm font-medium hover:bg-accent-hover transition-colors disabled:opacity-50"
                  >
              ...
              >
                <div
                  className={`
                    ...
                    ${selectedRole === role.value ? "bg-accent text-white" : "bg-hover text-secondary"}
                  `}
                >
