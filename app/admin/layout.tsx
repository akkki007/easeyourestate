...
`}
 ...
 <p className="text-xs text-muted-foreground truncate">admin@easeyourestate.com</p>
 </div>
 </div>
 <button
 ...
 {/* Top bar */}
 <header className="h-14 bg-muted/50 backdrop-blur-sm border-b border-border flex items-center justify-between px-4 md:px-6 sticky top-0 z-20">
 ...
 <h1 className="text-sm font-medium text-primary-foreground ml-2 lg:ml-0">
