  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-background shadow-sm border-b border-gray-100">
           ...
           <Link href={"/"}>
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              {showDashboard && (
                <Link
                  href="/dashboard"
                  className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-foreground hover:bg-gray-50 text-sm font-medium transition-colors"
                >
              ...
              {showAuthLinks && (
                <>
                  <Link
                    href="/signup"
                    className="px-5 py-2 text-sm font-medium text-foreground transition-colors rounded-lg hover:bg-gray-50"
                  >
                    Sign Up
                  </Link>
                  <Link
        ...
        {/* Mobile menu */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-100 bg-background px-4 py-3 flex flex-col gap-2">
