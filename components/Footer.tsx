...
export default function Footer() {
 ...
 <span className="text-[1.6rem] font-black text-primary-foreground leading-none tracking-tighter">eye</span>
 ...
 <span className="text-[8px] text-muted-foreground tracking-widest uppercase">at your service</span>
 <span className="text-[12px] font-bold text-primary-foreground tracking-tight">EaseYourEstate.ai</span>
 </div>
 </div>
 ...
 {/* Contact */}
 <div>
 <h4 className="text-primary-foreground font-semibold text-sm mb-4">Contact Us</h4>
 ...
 <div className="border-t border-border mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
