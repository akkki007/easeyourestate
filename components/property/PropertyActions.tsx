        ...
        <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
                <button
                    ...
                    className="flex flex-col items-center justify-center p-4 bg-purple-50 rounded-2xl border border-purple-100 text-purple-700 hover:bg-purple-100 transition-colors"
                >
            ...
            <div className="space-y-3">
                <div className="flex gap-2">
                    ...
                    {JSON.parse(localStorage.getItem("compareProperties") || "[]").length > 1 && (
                        <button
                            ...
                            className="px-4 py-3 bg-accent text-white rounded-xl font-bold text-sm hover:bg-accent-hover transition-colors flex items-center gap-2"
                        >
                            Compare Now
                        </button>
                    )}
                ...
                <button
                    ...
                    className="w-full py-3 px-4 bg-white border border-gray-200 text-gray-700 rounded-xl flex items-center justify-center gap-2 text-sm font-bold hover:border-purple-300 hover:text-purple-600 transition-all"
                >
...
function EnquiryModal({ property, onClose, token }: any) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5">Intent</label>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-4 bg-purple-600 text-white font-black rounded-2xl hover:bg-purple-700 transition-all flex items-center justify-center gap-2"
                    >
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5">Preferred Date</label>
                        <input
                            required
                            type="date"
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-purple-500 outline-none transition-all"
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5">Preferred Time</label>
                        <input
                            required
                            type="time"
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-purple-500 outline-none transition-all"
                    ...
                    <div>
                        <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5">Additional Notes</label>
                        <textarea
                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-purple-500 outline-none transition-all resize-none"
