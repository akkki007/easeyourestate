      ...
      {[
        ...
        return (
          <div key={s.key} className="flex items-center gap-2">
            ...
            {i < 2 && (
              <div className={`w-8 h-0.5 ${stepIdx < currentIdx ? "bg-purple-600" : "bg-gray-200"}`} />
            )}
          </div>
        );
      })}
          ...
          <div className="flex-1">
            ...
            {step === "profile" && (
              <form onSubmit={handleCompleteProfile} className="space-y-4">
                <div className="px-3 py-2 rounded-lg bg-purple-50 border border-purple-100 text-sm text-purple-700 font-medium">
