    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-between items-end mb-12">
          ...
          <button className="hidden md:block px-6 py-3 border border-gray-200 dark:border-border-dark rounded-xl text-sm font-medium hover:bg-white/5">
            View All Properties
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {properties.map((property, index) => (
            <div
              key={index}
              className="bg-white dark:bg-card-dark border border-gray-200 dark:border-border-dark p-6 rounded-3xl group"
            >
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                <span className="px-4 py-2 bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-border-dark rounded-full text-xs flex items-center gap-1.5">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="bg-primary px-5 py-3 rounded-xl text-sm font-medium hover:opacity-90">
                  View Details
                </button>
              </div>
            </div>
        ...
        {/* Pagination */}
        <div className="mt-12 pt-12 border-t border-gray-200 dark:border-border-dark flex items-center justify-between">
          <span className="text-sm font-medium">
            01 <span className="text-gray-500">of 60</span>
          </span>
          <div className="flex gap-4">
            <button className="w-12 h-12 rounded-full border border-gray-200 dark:border-border-dark flex items-center justify-center hover:bg-white/5">
