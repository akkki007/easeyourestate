                ...
                users.map((u) => {
                  ...
                  return (
                    <tr key={u._id} className="border-b border-gray-800/50 hover:bg-gray-800/30">
                      ...
                      <td className="px-4 py-3">
                        <span className="px-2 py-0.5 rounded-md bg-gray-800 text-gray-300 text-xs font-medium capitalize">
                          {u.role}
                        </span>
                      </td>
                      <td className="px-4 py-3">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-gray-800">
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={page === 1}
                className="px-3 py-1 rounded text-xs text-gray-400 hover:bg-gray-800 disabled:opacity-30 transition-colors"
              >
                Prev
              </button>
              <button
        ...
        <>
          ...
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-full max-w-sm bg-gray-900 border border-gray-800 rounded-2xl p-6">
            ...
            <select
              ...
              className="w-full px-3 py-2 rounded-lg bg-gray-800 border border-gray-700 text-sm text-white mb-4 focus:border-accent focus:outline-none"
            >
              {ROLES.filter(Boolean).map((r) => (
                <option key={r} value={r}>{r}</option>
              ))}
