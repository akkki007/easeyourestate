export default function Footer() {
  ...
  return (
    <footer className="bg-white dark:bg-card-dark pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-20">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="relative max-w-sm mb-8">
              ...
              <input
                className="w-full bg-gray-50 dark:bg-[#1A1A1A] border border-gray-200 dark:border-border-dark rounded-2xl py-4 pl-12 pr-12 focus:outline-none focus:ring-2 focus:ring-primary/50"
        ...
        {/* Bottom Bar */}
        <div className="pt-8 border-t border-gray-200 dark:border-border-dark flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex gap-8 text-sm font-medium">
            <span className="text-gray-500">© 2024 Estatein. All Rights Reserved.</span>
          ...
          <div className="flex gap-4">
            <a
              className="w-10 h-10 rounded-full bg-gray-50 dark:bg-background-dark border border-gray-200 dark:border-border-dark flex items-center justify-center hover:bg-primary hover:text-white transition-all"
              href="#"
            >
